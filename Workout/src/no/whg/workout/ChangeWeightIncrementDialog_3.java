...
public class ChangeWeightIncrementDialog_3 extends DialogPreference {

	public NumberPicker np_1;
	double currentIncrement = 0;
	
	public ChangeWeightIncrementDialog_3(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			...
			MainActivity.SLCalc.getBothSessions().get(2).setWeightIncrement(currentIncrement);
			break;
		}
	}
	...
	public void createDefaultNumberPickers(){
		...
		currentIncrement = exercises.get(2).getWeightIncrement();
