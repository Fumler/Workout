...
public class ChangeWeightIncrementDialog_2 extends DialogPreference {

	public NumberPicker np_1;
	double currentIncrement = 0;
	
	public ChangeWeightIncrementDialog_2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			...
			MainActivity.SLCalc.getBothSessions().get(1).setWeightIncrement(currentIncrement);
			break;
		}
	}
	...
	public void createDefaultNumberPickers(){
		...
		currentIncrement = exercises.get(1).getWeightIncrement();
