...
public class SetWeightDialog_5 extends DialogPreference {
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			...
			MainActivity.SLCalc.getBothSessions().get(4).setNumberOfSets(np_5.getValue());
			break;
		}
	...
	public void createDefaultNumberPickers(){
		...
		currentWeight = exercises.get(4).getCurrentWeight();
		convertSingleIntToMulti(currentWeight);
		
		switch ((int)exercises.get(4).getNumberOfSets()) {
		case 1:
			np_5.setValue(1);
			break;
		case 3:
