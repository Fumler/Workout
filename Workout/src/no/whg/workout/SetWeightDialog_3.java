...
public class SetWeightDialog_3 extends DialogPreference {
	...
	public SetWeightDialog_3(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			MainActivity.SLCalc.getBothSessions().get(2).setCurrentWeight(convertMultiIntToSingle());
			MainActivity.SLCalc.getBothSessions().get(2).setNumberOfSets(np_5.getValue());
			break;
		}
	...
	public void createDefaultNumberPickers(){
		...
		currentWeight = exercises.get(2).getCurrentWeight();
		convertSingleIntToMulti(currentWeight);
		
		switch ((int)exercises.get(2).getNumberOfSets()) {
		case 1:
			np_5.setValue(1);
			break;
		case 3:
